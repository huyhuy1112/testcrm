{* Campaigns list / header icons (designer megaphone, 24px) *}
{strip}
{if $ICON eq 'MEGAPHONE'}
<svg class="mk-camp-svg mk-camp-svg--designer" width="24" height="24" viewBox="24 62 20 17" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
