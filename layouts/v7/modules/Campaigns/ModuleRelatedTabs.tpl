{* Campaigns: Marketing detail tabs (Details / Updates + related icons) *}
{strip}
	<div class="related-tabs row {if (isset($SELECTED_MENU_CATEGORY) && $SELECTED_MENU_CATEGORY eq 'MARKETING') || (isset($smarty.get.app) && $smarty.get.app eq 'MARKETING')}mk-camp-detail-related-tabs{/if}">
...
{if (isset($SELECTED_MENU_CATEGORY) && $SELECTED_MENU_CATEGORY eq 'MARKETING') || (isset($smarty.get.app) && $smarty.get.app eq 'MARKETING')}
					<li class="mk-camp-detail-tabs-spacer" role="presentation" aria-hidden="true"></li>
{/if}
