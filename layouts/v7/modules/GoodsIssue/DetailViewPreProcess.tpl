{*+**********************************************************************************
 * GoodsIssue Outbound Detail (Inventory app): split shell + topbar.
 ************************************************************************************}
...
<link rel="stylesheet" type="text/css" href="{vresource_url('layouts/v7/modules/GoodsIssue/resources/GoodsIssueDetail.css')}" />
<script type="text/javascript" src="{vresource_url('layouts/v7/modules/Vtiger/resources/DashboardSidebarNav.js')}"></script>
<script type="text/javascript" src="{vresource_url('layouts/v7/modules/GoodsIssue/resources/Detail.js')}"></script>
<div id="mk-dash-split-root" class="mk-dash-split-root" data-mk-dash-split-root="1" data-mk-goodsissue-detail="1">
