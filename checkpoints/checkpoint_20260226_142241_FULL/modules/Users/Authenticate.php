...
$successURL = 'index.php?module=Home&view=MainPage&app=MANAGEMENT';
...
if($focus->is_authenticated()) {
	...
	// Ghi thêm vào vtiger_loginhistory để Team Status (Main Page) hiển thị đúng online cho mọi user
	if (class_exists('Users_Module_Model')) {
		Users_Module_Model::getInstance('Users')->saveLoginHistory($focus->column_fields["user_name"]);
	}
