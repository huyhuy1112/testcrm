...
class Install_InitSchema_Model {
	...
	public static function registerCronTasks() {
		...
		Vtiger_Cron::register( 'DeadlineReminder', 'cron/DeadlineReminder.service', 86400, 'Vtiger', 1, 6, 'Check and send deadline reminders for Projects, ProjectTasks, Calendar, and Potentials (runs daily)');
	}
