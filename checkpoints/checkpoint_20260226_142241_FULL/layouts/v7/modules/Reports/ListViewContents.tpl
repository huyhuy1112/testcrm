...
{strip}
	<div class="col-sm-12 col-xs-12 ">
        ...
        {* Management – Report: summary section *}
        <div class="management-report-spec">
            <div class="management-report-spec__top">
                <div class="management-report-spec__intro">
                    <h2 class="management-report-spec__title">4. Management – Report</h2>
                    <div class="management-report-spec__section">
                        <h3>Mục đích</h3>
                        <ul>
                            <li>Cung cấp báo cáo tổng hợp và chi tiết về hoạt động doanh nghiệp (Projects, Tasks, KPI, Documents, Sales, Marketing...).</li>
                            <li>Hỗ trợ quản lý / ban lãnh đạo nắm tình hình nhanh, so sánh giữa các phòng ban, kênh.</li>
                            <li>Giúp đưa ra quyết định chính xác dựa trên số liệu thực tế.</li>
                        </ul>
                    </div>
                    <div class="management-report-spec__section">
                        <h3>Mô tả chi tiết</h3>
                        <ul>
                            <li>Người dùng: Quản lý PKD, quản lý phòng ban, ban giám đốc.</li>
                            <li>Cấp độ thông tin: Management → Report.</li>
                            <li>Thông tin cho Report: tổng quan + theo từng thành phần (Project, Task, MKT SALE, KPI).</li>
                        </ul>
                    </div>
                    <div class="management-report-spec__section">
                        <h3>Luồng nghiệp vụ</h3>
                        <ol>
                            <li>Người dùng đăng nhập → vào Management → Report.</li>
                            <li>Chọn loại báo cáo → chọn bộ lọc (thời gian, phòng ban, người phụ trách, trạng thái).</li>
                            <li>Hệ thống hiển thị báo cáo dạng bảng/biểu đồ.</li>
                            <li>Người dùng có thể xuất báo cáo ra file (PDF, Excel, CSV).</li>
                        </ol>
                    </div>
                </div>
                <div class="management-report-spec__components">
                    <table class="management-report-spec__table management-report-spec__table--components">
                        <thead>
                            <tr>
                                <th>Thành phần</th>
                                <th>Nội dung</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Tiến độ dự án, số lượng Task hoàn thành/chưa hoàn thành, deadline, người phụ trách.</td>
                            </tr>
                            <tr>
                                <td>Task Report</td>
                                <td>Task theo trạng thái (To Do, In Progress, Done), Task quá hạn, Task theo nhân viên.</td>
                            </tr>
                            <tr>
                                <td>MKT SALE</td>
                                <td>Doanh số, pipeline khách hàng, hiệu quả chiến dịch marketing.</td>
                            </tr>
                            <tr>
                                <td>KPI Report</td>
                                <td>KPI theo phòng ban/cá nhân, tỷ lệ hoàn thành KPI.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            </div>
            <div class="management-report-spec__bottom">
                <table class="management-report-spec__table management-report-spec__table--functions">
                    <thead>
                        <tr>
                            <th>Chức năng</th>
                            <th>Mô tả</th>
                    ...
                    <tbody>
                        <tr>
                            <td>Tạo báo cáo theo loại</td>
                            <td>Lựa chọn loại báo cáo và các dữ liệu đầu vào.</td>
                        </tr>
                        <tr>
                            <td>Hiển thị</td>
                            <td>Báo cáo được hiển thị dạng bảng và biểu đồ.</td>
                        </tr>
                        <tr>
                            <td>Bộ lọc</td>
                            <td>Lọc theo thời gian, phòng ban, người phụ trách, trạng thái,...</td>
                        </tr>
                        <tr>
                            <td>Xuất file</td>
                            <td>Xuất báo cáo ra nhiều định dạng (PDF, Excel, CSV).</td>
                        </tr>
                        <tr>
                            <td>Lưu cấu hình</td>
                            <td>Lưu cấu hình các loại báo cáo đã tạo để dùng lần sau.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
