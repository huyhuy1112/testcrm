...
<div class="sidebar-menu">
    {if !isset($CUSTOM_VIEWS)}{assign var="CUSTOM_VIEWS" value=array()}{/if}
    {if !isset($CUSTOM_VIEWS_NAMES)}{assign var="CUSTOM_VIEWS_NAMES" value=array()}{/if}
				...
				<div class="list-menu-content">
                        ...
                        {if $CUSTOM_VIEWS && php7_count($CUSTOM_VIEWS) > 0}
                            ...
                            <div class="list-group" id="{if $GROUP_LABEL eq 'Mine'}myList{else}sharedList{/if}">   
                                ...
                                {assign var="ALL_CV" value=CustomView_Record_Model::getAllFilterByModule($MODULE)}
                                <input type="hidden" name="allCvId" value="{if $ALL_CV}{$ALL_CV->get('cvid')}{/if}" />
                                <ul class="lists-menu">
