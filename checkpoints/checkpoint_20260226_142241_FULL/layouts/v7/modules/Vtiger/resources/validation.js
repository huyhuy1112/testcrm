...
jQuery.validator.addMethod(
  ...
  function (value, element, params) {
    ...
    if (
      ...
      console.log(
        "greaterThanDependentField() validation method should be used for date fields only"
      );
      return result;
    }
  ...
  $.fn.vtValidate = function (params) {
      ...
      invalidHandler: function (form, validator) {
        ...
        var msg =
          typeof app !== "undefined" && app.vtranslate
            ? app.vtranslate("JS_PLEASE_FILL_REQUIRED_FIELDS") ||
    ...
    this.on(
      ...
      function (e) {
        ...
        var form = referenceElement.closest("form");
        if (form.length && form.data("validator")) {
          try {
