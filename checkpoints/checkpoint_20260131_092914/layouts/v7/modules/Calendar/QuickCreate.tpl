			...
			<form class="form-horizontal recordEditView" id="QuickCreate" name="QuickCreate" method="post" action="index.php">
				...
				<div class="modal-body">
					...
					<div class="quickCreateContent calendarQuickCreateContent" style="padding-top:2%;margin-top:5px;">
						...
						{* ----- TASK (Calendar): Form kiểu Google Tasks ----- *}
						{if $MODULE eq 'Calendar'}
						<div class="google-task-form" style="margin-top: 16px;">
							{* Hàng 1: Icon đồng hồ + Ngày bắt đầu *}
							<div class="google-task-row" style="display: flex; align-items: center; margin-bottom: 12px;">
								<span class="fa fa-clock-o" style="width: 24px; margin-right: 12px; color: #5f6368;"></span>
								<div style="flex: 1;">
							...
							<div class="google-task-row" style="margin-bottom: 12px; padding-left: 36px;">
								...
								<select name="calendar_repeat_type" id="calendar_repeat_type" class="form-control input-sm" style="display: inline-block; width: auto; min-width: 140px;">
							...
							{* Hàng 2: Icon target + Add deadline *}
							<div class="google-task-row" style="display: flex; align-items: center; margin-bottom: 12px;">
							...
							{* Hàng 3: Icon lines + Add description *}
