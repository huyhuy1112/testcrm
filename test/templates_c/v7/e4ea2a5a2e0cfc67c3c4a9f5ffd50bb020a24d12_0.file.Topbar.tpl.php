<?php
/* Smarty version 4.5.4, created on 2026-01-06 06:41:30
  from '/var/www/html/layouts/v7/modules/Vtiger/partials/Topbar.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_695cae9a05cef7_21919865',
...
function content_695cae9a05cef7_21919865 (Smarty_Internal_Template $_smarty_tpl) {
...
" aria-hidden="true"></a></div></li><?php }?><li class="dropdown" id="modern-notifications-container"><div><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" id="modern-notifications-bell" title="<?php echo vtranslate('LBL_NOTIFICATIONS','Vtiger');?>
"><span class="fa fa-bell" aria-hidden="true"></span><span class="badge modern-notifications-badge" id="modern-notifications-count" style="display: none;">0</span></a><ul class="dropdown-menu modern-notifications-dropdown" role="menu" id="modern-notifications-list" style="min-width: 300px; max-height: 400px; overflow-y: auto;"><li class="dropdown-header" style="padding: 10px 15px;"><div style="margin-bottom: 10px;"><strong><?php echo vtranslate('LBL_NOTIFICATIONS','Vtiger');?>
</strong><div class="pull-right" style="display: none;" id="modern-notifications-actions"><button type="button" id="modern-notifications-mark-all-read" class="btn btn-xs btn-link" style="padding: 0 5px; color: #337ab7; margin-right: 5px;">Đã đọc hết</button><button type="button" id="modern-notifications-delete-selected" class="btn btn-xs btn-link" style="padding: 0 5px; color: #d9534f; margin-right: 5px; display: none;">Xóa đã chọn</button><button type="button" id="modern-notifications-delete-all" class="btn btn-xs btn-link" style="padding: 0 5px; color: #d9534f;">Xóa hết</button></div></div><ul class="nav nav-tabs" style="border-bottom: 1px solid #ddd; margin: 0 -15px 0 -15px; padding: 0 15px;"><li role="presentation" class="active" id="modern-notifications-tab-unread"><a href="#" id="modern-notifications-tab-unread-link" style="padding: 8px 12px; cursor: pointer;">Chưa đọc</a></li><li role="presentation" id="modern-notifications-tab-read"><a href="#" id="modern-notifications-tab-read-link" style="padding: 8px 12px; cursor: pointer;">Đã đọc</a></li></ul></li><li role="separator" class="divider"></li><li id="modern-notifications-empty-unread" style="padding: 10px; text-align: center; color: #999;">Không có thông báo chưa đọc</li><li id="modern-notifications-empty-read" style="padding: 10px; text-align: center; color: #999; display: none;">Không có thông báo đã đọc</li><li id="modern-notifications-items" style="display: none;"></li></ul></div></li><li class="dropdown"><div><a href="#" class="userName dropdown-toggle pull-right" data-toggle="dropdown" role="button"><span class="fa fa-user" aria-hidden="true" title="<?php echo $_smarty_tpl->tpl_vars['USER_MODEL']->value->get('userlabel');?>
