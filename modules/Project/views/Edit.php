<?php
/*+**********************************************************************************
 * Project Edit: load team group + additional assignees for form.
 *************************************************************************************/
...
class Project_Edit_View extends Vtiger_Edit_View {
	...
	public function process(Vtiger_Request $request) {
		...
		// Build record model like parent
		if (!empty($recordId) && $request->get('isDuplicate') == true) {
			...
			// duplicate: no team group / assignees from source
			...
			// If this project is assigned to a team group, show group in Assigned To (value = -groupid)
		...
		// Additional assignees: list of user ids for this project
	...
	/**
	 * Load ProjectTeamGroup.js so Assigned To team group + _team_group_id work on Project Edit.
	 */
